...
export default function App() {
  ...
  const commandPaletteActions: CommandPaletteAction[] = [
    ...
    { id: 'act_tpl_blank', title: 'Page Template: Clean Page (Blank White)', category: 'Template', run: () => handleUpdatePageTemplate('blank') },
    { id: 'act_tpl_black', title: 'Page Template: Complete Black (#000000)', category: 'Template', run: () => handleUpdatePageTemplate('black') },
    { id: 'act_tpl_ruled', title: 'Page Template: Ruled Lines', category: 'Template', run: () => handleUpdatePageTemplate('ruled') },
    { id: 'act_tpl_grid', title: 'Page Template: Square Grid', category: 'Template', run: () => handleUpdatePageTemplate('grid') },
    { id: 'act_tpl_graph', title: 'Page Template: Fine Graph', category: 'Template', run: () => handleUpdatePageTemplate('graph') },
